Operator to retrieve data from a CKAN resource. The resource's id can be specified with the resource preferenece or with a parameter in the url of an iframed mashup.
